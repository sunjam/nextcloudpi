...
[v1.29.5](https://github.com/nextcloud/nextcloudpi/commit/5051b14) (2020-08-29) ncp-web: Fix the style of the language selection dropdown (chrome)

[v1.29.4, devel](https://github.com/nextcloud/nextcloudpi/commit/17aae56) (2020-08-30) ncp-update-nc: check for ncc commands before using them
